                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-12 col-sm-12 md-mb-10">
                            ...
                            <ul class="footer-social md-mb-30">  
                                <li> 
                                <a href="https://www.instagram.com/prolineautomacao/" target="_blank"><span>Nos Siga no Instagram: <i class="fa fa-instagram"></i></span></a> 
                                </li>                                     
                            </ul>
                        </div>
                        <div class="col-lg-3 col-md-12 col-sm-12 md-mb-10">
        ...
        <!-- Time Circle js -->
        <script src="{{url('/')}}/assets/js/time-circle.js"></script>
        <!-- isotope.pkgd.min js -->
